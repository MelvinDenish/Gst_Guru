...
const GST_ITEMS = [
    ...
    { hsn: "6401", name: "Footwear", category: "Textiles & Apparel", rate: 5, desc: "Footwear (all types)", price_slabs: [{ max_value: 1000, rate: 5 }, { max_value: null, rate: 18 }] },
    ...
    // AUTOMOBILES & PARTS
    { hsn: "8703", name: "Motor Cars", category: "Automobiles & Parts", rate: 28, desc: "Motor cars and vehicles", applicability: { type: "automobile", variants: [{ label: "Small Car (Petrol ≤ 1200cc)", cess: 1 }, { label: "Mid-Size Car (1200-1500cc)", cess: 3 }, { label: "Large Car (> 1500cc)", cess: 15 }, { label: "SUV (> 1500cc, > 4m)", cess: 22 }] } },
    { hsn: "8711", name: "Motorcycles", category: "Automobiles & Parts", rate: 28, desc: "Motorcycles", applicability: { type: "automobile", variants: [{ label: "≤ 350cc", cess: 3 }, { label: "> 350cc", cess: 15 }] } },
    ...
    { hsn: "9963", name: "Hotel Accommodation", category: "Services", rate: 12, desc: "Hotel room services", price_slabs: [{ max_value: 1000, rate: 0 }, { max_value: 7500, rate: 12 }, { max_value: null, rate: 18 }] },
    ...
    { hsn: "9965", name: "Goods Transport (GTA)", category: "Services", rate: 5, desc: "GTA services", is_rcm: true },
    ...
    { hsn: "9982", name: "Legal Services", category: "Services", rate: 18, desc: "Legal, accounting", is_rcm: true },
    ...
    { hsn: "5201", name: "Raw Cotton", category: "Agriculture & Farming", rate: 5, desc: "Cotton, uncarded", is_rcm: true },
